  ...
  return (
    <>
      ...
      onCancel={() => {
        setShowIntro(false)}}
        footer={[
          <Button key ="gotit" type="primary" size="large" onClick={() => {
        ...
        <div className="mb-4 text-2xl font-bold w-full ">          
          <p>Congratulations!!!</p>
        </div>
        <div className="text-lg">
          <p>You’ve been selected for the interview round of this job profile.</p>

          <p>
            Before we start, let’s complete a few basic steps:
          </p>
          <ul className="list-disc ml-6 space-y-2">
            <li>Click the plus icon to upload your resume.</li>
            <li>AI will parse your resume and pre-fill your information.</li>
            <li>
              Please review and confirm that the information is correct.
            </li>
            <li>Once confirmed, you can begin your interview.</li>
          </ul>
          <p className="mt-5 text-lg font-bold">Good Luck!!!</p>
        </div>
      </Modal>
      ...
      <div className="w-full h-screen bg-[#F2F1e6] flex flex-col">
        ...
        >
          <p>
            Looks like you have an unfinished interview. Would you like to
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <input
              ...
              onBlur={(e) =>
                dispatch(
                  updateCandidateField({ field: "name", value: e.target.value })
                )
              }
            />
            <input
        ...
        <div className="w-[80%] h-full overflow-y-auto mx-auto flex flex-col justify-end ">
          <div className="w-[60%] h-full mx-auto flex justify-start items-end">
            <Card
